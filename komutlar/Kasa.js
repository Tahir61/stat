  ...
  if (komut == "aç") {
    ...
    if (kasa == "L1-KASA") {
      if (!para) {
        ...
        client.channels.cache.get(gold).send(`:dollar:  ${message.member} **L1-KASA**'yı satın aldı!`)
      ...
      if (!para) {
        ...
        client.channels.cache.get(gold).send(`:dollar:  ${message.member} **L2-KASA**'yı satın aldı!`)
      ...
      if (!para) {
        ...
        client.channels.cache.get(gold).send(`:dollar:  ${message.member} **L3-KASA**'yı satın aldı!`)
      }
    } else {
      const embed = new Discord.MessageEmbed()
        .setColor("RED")
